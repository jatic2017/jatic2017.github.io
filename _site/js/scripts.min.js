(function(a) {
    a(document).ready(function() {
        a(window).load(function() { a("#st-container").removeClass("disable-scrolling");
            a("#loading-animation").fadeOut();
            a("#preloader").delay(350).fadeOut(800); var b = document.createElement("script");
            b.type = "text/javascript";
            b.async = !0;
            b.src = "https://apis.google.com/js/platform.js"; var d = document.getElementsByTagName("script")[0];
            d.parentNode.insertBefore(b, d);
            equalheight(".same-height") });
        1500 < a(window).width() && a(".effect-wrapper").addClass("col-lg-3");
        768 > a(window).width() &&
            (a(".animated").removeClass("animated").removeClass("hiding"), a(".stat span").removeClass("timer"), a(".timeslot-label").addClass("stick-label"));
        ...
        a(window).resize(function() {
            ...
            768 > a(window).width() ? (a(".same-height").css("height", "100%"), a(".timeslot-label").addClass("stick-label")) : (a(".timeslot-label").removeClass("stick-label"), c.hasClass("st-menu-open") && (c.removeClass("st-menu-open"), a("body").css("overflow", "auto")), equalheight(".same-height"));
            512 > a(window).height() ? (a(".st-menu").addClass("scrollable"), a("#bottom-navlinks").removeClass("bottom-navlinks").addClass("bottom-navlinks-small")) : (a(".st-menu").removeClass("scrollable"), a("#bottom-navlinks").removeClass("bottom-navlinks-small").addClass("bottom-navlinks"))
        });
        a(function() {
        ...
        a(function() { a("a[href=#]").click(function() { event.preventDefault() }) });
        a(function() {-1 < window.location.href.indexOf("schedule") && window.location.hash && a(window.location.hash).click() });
        a(function() { var b, d, c, e, f;
            f = a(".appear-animation");
            c = 0; for (e = f.length; c < e; c++) d = f[c], b = d.offsetLeft + d.offsetTop, b /= 1E3, a(d).css("transition-delay", "" + .47 * b + "s"), a(d).css("transition-duration", "0.2s") });
        a(".appear-animation-trigger").appear(function() {
            setTimeout(function() { a(".appear-animation-trigger").parent("div").find(".appear-animation").addClass("visible") },
                1E3)
        });
        a(".animated").appear(function() { var b = a(this),
                d = b.data("animation"),
                c = b.data("delay");
            c ? setTimeout(function() { b.addClass(d + " visible");
                b.removeClass("hiding");
                b.hasClass("counter") && b.find(".timer").countTo() }, c) : (b.addClass(d + " visible"), b.removeClass("hiding"), b.hasClass("counter") && b.find(".timer").countTo()) }, { accY: -150 });
            ...
            a(b).each(function() {
                ...
                if (c != topPostion) {
                    for (currentDiv = 0; currentDiv <
                        e.length; currentDiv++) e[currentDiv].height(d);
                    e.length = 0;
                    c = topPostion;
                    d = f.height();
                    e.push(f)
        ...
        a("#menu-trigger").click(function(a) { a.stopPropagation();
            c.toggleClass("st-menu-open") });
        a(".st-pusher").click(function() { c.hasClass("st-menu-open") && c.removeClass("st-menu-open") });
        a(".track-header").each(function() {
            for (var b = a(this).closest(".schedule-table").find(".slot").first(),
                    d; void 0 === d;) d = b.data("slotDetail"), b = b.next();
            a(this).find(".slot-detail").html(d)
        });
        a("#post-section .post-body p").each(function() { if (a(this).find(".feature-image").length) { var b = a(this).find(".feature-image").prop("src");
                a("#top-section").css("background-image", "url(" + b + ")").addClass("enable-overlay") } });
        a(".slider").each(function() { a(this).find(".slider-item").first().addClass("slider-current-item").removeClass("hidden");
            1 < a(this).find(".slider-item").length && a(this).closest(".speaker-item").find(".slider-next-item").removeClass("hidden") });
        a(".slider-next-item").click(function() { var b = a(this).closest("div"),
                d = b.find(".slider-current-item").next();
            d.length ? (d.addClass("slider-current-item").removeClass("hidden"), b.find(".slider-current-item").first().removeClass("slider-current-item").addClass("hidden")) : (b.find(".slider-item").first().addClass("slider-current-item").removeClass("hidden"), b.find(".slider-current-item").last().removeClass("slider-current-item").addClass("hidden")) });
        a(".modal").on("hidden.bs.modal", function() {
            var b = a(this).find("iframe");
            b.attr("src", b.attr("src"))
        });
        a(".slot").click(function() { location.hash = a(this).attr("id") });
        if ("undefined" !== typeof twitterFeedUrl) {
            var h = function() { var b = a("#tweets").find(".tweet"),
                    d = 0;
                a(b.get(0)).removeClass("hidden");
                setInterval(function() { var c = ++d % b.length;
                    a(b.get(c - 1)).addClass("hidden");
                    a(b.get(c)).removeClass("hidden") }, 5E3) };
            a.getJSON(twitterFeedUrl, function(b) {
                a.each(b, function(b, c) {
                    ...
                    e = '<div class="tweet animated fadeInUp hidden"><p class="tweet-text">' + e + '</p><p class="tweet-meta">by <a href="https://twitter.com/' + c.user.screen_name + '" target="_blank">@' + c.user.screen_name + "</a></p></div>";
                    a("#tweets").append(e)
                });
                h()
            })
    ...
    if ("undefined" !== typeof googleMaps) {
        ...
        google.maps.event.addDomListener(window, "load", function() {
            function m(k, f) {
                x.route({ origin: k, destination: eventPlace, travelMode: google.maps.TravelMode[f] }, function(d, e) {
                    if (e == google.maps.DirectionsStatus.OK) {
                        ...
                        " km"), a("#estimateTime").text(""), a("#find-flight").removeClass("hidden"), a("#mode").addClass("hidden"))
                });
                d();
            ...
            function u() { navigator.geolocation && navigator.geolocation.getCurrentPosition(function(a) { h = new google.maps.LatLng(a.coords.latitude, a.coords.longitude);
                    m(h, "TRANSIT") }) }

            function b(a) { a = new google.maps.Marker({ position: a, map: c, icon: icon });
                l.push(a) }

            function d() {
                for (var a = 0; a <
                    l.length; a++) l[a].setMap(null);
                l = []
            }

            function v(a) { var b = c.getZoom(),
                    d = Math.abs(a - b),
                    e = a > b ? 1 : -1; for (a = 0; a < d; a++) setTimeout(function() { b += e;
                    c.setZoom(b) }, 50 * (a + 1)) }

            function e(b) { r.geocode({ latLng: b }, function(b, c) { c == google.maps.GeocoderStatus.OK && b[1] && a.each(b[1].address_components, function(b, c) { if ("locality" == c.types[0]) return a("#result-name").text(c.long_name), !1 }) }) }
            ...
            var f = { zoom: 17, minZoom: 2, scrollwheel: !1, panControl: !1, draggable: !0, zoomControl: !1, zoomControlOptions: { position: google.maps.ControlPosition.RIGHT_TOP }, scaleControl: !1, mapTypeControl: !1, streetViewControl: !1, center: centerMap, mapTypeControlOptions: { mapTypeIds: [google.maps.MapTypeId.ROADMAP, "custom_style"] }, mapTypeId: "custom_style" };
            768 > a(window).width() && (f.center = mobileCenterMap);
            "logistics" == googleMaps && (f.zoom = 5, f.zoomControl = !0);
            c = new google.maps.Map(document.getElementById("canvas-map"),
                f);
            var t = new google.maps.Marker({ position: eventPlace, animation: google.maps.Animation.DROP, icon: icon, map: c });
            l.push(t);
            var f = new google.maps.StyledMapType([{ stylers: [{ lightness: 40 }, { visibility: "on" }, { gamma: .9 }, { weight: .4 }] }, { elementType: "labels", stylers: [{ visibility: "on" }] }, { featureType: "water", stylers: [{ color: "#5dc7ff" }] }, { featureType: "road", stylers: [{ visibility: "off" }] }], { name: "Default Style" }),
                w = new google.maps.StyledMapType([{ stylers: [{ lightness: 40 }, { visibility: "on" }, { gamma: 1.1 }, { weight: .9 }] },
                    { elementType: "labels", stylers: [{ visibility: "off" }] }, { featureType: "water", stylers: [{ color: "#5dc7ff" }] }, { featureType: "road", stylers: [{ visibility: "on" }] }, { featureType: "road", elementType: "labels", stylers: [{ saturation: -30 }] }
                ], { name: "Zoomed Style" });
            c.mapTypes.set("default", f);
            c.mapTypes.set("zoomed", w);
            "logistics" === googleMaps ? (c.setMapTypeId("default"), f = document.getElementById("location-input"), q = new google.maps.places.Autocomplete(f), google.maps.event.addListener(q, "place_changed", function() {
                t.setVisible(!1);
                var a = q.getPlace();
                if ("undefined" != a.geometry && a.geometry) { var b = "";
                    ...
                    r.geocode({ address: b }, function(a, b) { b == google.maps.GeocoderStatus.OK ? (h = a[0].geometry.location, m(h, "TRANSIT")) : alert("Geocode was not successful for the following reason: " + b) }) }
            })) : c.setMapTypeId("zoomed");
            a("#mode-select").change(function() { var b = a(this).val();
                m(h, b) });
            a("#direction-locate").click(u);
            a("#direction-cancel").click(function() { a("#find-way").removeClass("location-active");
            ...
            "undefined" !==
            typeof autoDirectionEnabled && 1 == autoDirectionEnabled && u()
        })
    }
})(jQuery);